import { xRotate, yRotate, zRotate, translate } from './translate'

function nearColor(color: any): number[] {
    const maxDiff = 30
    let r = color[0],
        g = color[1],
        b = color[2]
...
export class Polygon {
    ...
    constructor(gl: WebGLRenderingContext, faces: any, pos = [0, 0, 0]) {
        this.faces = faces
